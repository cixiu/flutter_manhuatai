...
Data _$DataFromJson(Map<String, dynamic> json) {
  return Data(
      ...
      (json['insider_list'] as List)
          ?.map((e) => e == null
              ? null
              : Insider_list.fromJson(e as Map<String, dynamic>))
          ?.toList(),
      json['call_data'] == null
          ? null
...
Insider_list _$Insider_listFromJson(Map<String, dynamic> json) {
  return Insider_list(json['uid'] as int, json['counts'] as int,
      json['Uname'] as String, json['level'] as int, json['isvip'] as int);
}
